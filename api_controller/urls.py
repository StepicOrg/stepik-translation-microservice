...
urlpatterns = [
    ...
    url(r'^api/translation/step_sources/(?P<pk>[0-9]+)$', step_source_detail, name="step-source-datail"),
    url(r'^api/translation/step_sources/$', step_source_list, name="step-source-list"),
