...
from api_controller.views import TranslatedStepViewSet, TranslatedLessonViewSet, AvailableLanguagesViewSet, \
    TranslationalRatioViewSet, TranslatedCourseViewSet, TranslatedStepSourceViewSet, TranslatedAttemptViewSet
...
attempt_detail = TranslatedAttemptViewSet.as_view({"get": "retrieve"})
...
urlpatterns = [
    ...
    url(r'^api/translation/attempts/(?P<pk>[0-9]+)$', attempt_detail, name="attempt-detail"),
